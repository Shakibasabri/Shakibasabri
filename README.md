...
currently_learning: ["Startup management,Machine learning systems , Real time Deep learning Algorithms, big data, Cloud computing"]
2024 Goals: ["Generate more code and work on personal coding projects, Read and learn more about emerging technologies and industry trends."]
hobbies: ["Painting", "Ping Pong", "Music", "Reading"]
```
